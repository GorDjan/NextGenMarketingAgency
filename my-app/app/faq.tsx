...
const FAQS = () => {
    ...
    <AccordionItem value="item-1">
      <AccordionTrigger>What is MarketPulse?</AccordionTrigger>
      <AccordionContent>
		MarketPulse is a full fledge marketing agency that specializes in branding, web design, and digital marketing.
      </AccordionContent>
    </AccordionItem>
