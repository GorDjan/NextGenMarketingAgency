...
const FormSchema = z.object({
  ...
  help: z.enum([
    "Evaluate MarketPulse for my company",
    "Learn More",
    "Get a Quote",
    "Other",
  ]),
...
type FormValues = {
  ...
  job_title: string;
  company_name: string;
  help: "Evaluate MarketPulse for my company" | "Learn More" | "Get a Quote" | "Other";
  services:
    | "Mobile App Develoment"
    | "Social Media Marketing"
    | "UI/UX Design"
          ...
          <div
            className="
              ...
              text-gray-300
                    "
          >
            Let&apos;s talk about how MarketPulse can help your team work better.
          </div>
            ...
            >
                ...
                render={({ field }) => (
                  <FormItem className="items-center justify-center  w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate MarketPulse for my company">
                            Evaluate MarketPulse for my company
                          </SelectItem>
                        </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to MarketPulse&apos; sending marketing communications related
                  to MarketPulse
                </div>
              </div>
